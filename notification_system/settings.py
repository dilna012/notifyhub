...
SECRET_KEY = 'django-insecure-)l#r-9p1!f96xcwa(ma=o3795rdlwfc1#w+n*p*0xt)z#14#x0'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Keep this
...
EMAIL_HOST_USER = 'anamikakdineshan@gmail.com'
EMAIL_HOST_PASSWORD = 'kiyjajahzezwdhuj'
